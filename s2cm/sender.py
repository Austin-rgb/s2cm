...
class SCMSender:
    ...
    def send(self,username, message):
        ...
        """
        self.session.post(f'{self.server_url}/send',data=dict(username=username,message=message))
    ...
    def set_hs(self, username, session ):
        ...
        """
        self.session.post(f'{self.server_url}/set_username',  data=dict(username =username, session =session ))
